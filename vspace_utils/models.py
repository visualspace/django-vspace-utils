...
class UniqueSlugItemBase(models.Model):
    ...
    slug = models.SlugField(unique=True, help_text=_(
            'Short name for an item, used for constructing its web addres. '
            'A slug should be unique and may only contain letters, numbers '
            'and \'-\'.'), blank=True)
...
class NonUniqueSlugItemBase(models.Model):
    ...
    slug = models.SlugField(unique=False, help_text=_(
            'Short name for an item, used for constructing its web addres. '
            'A slug should be unique and may only contain letters, numbers '
            'and \'-\'.'), blank=True)
